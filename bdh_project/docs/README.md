...
| Configuration | Validation Accuracy | Time |
|---------------|---------------------|------|
| **Baseline** | 61.25% ± 5.45% | ~4 min |
| **LTC** | 61-62% | ~4 min |
| **Combined** | 60-63% | ~52 min |
...
For detailed command-line arguments and experimental modes, see the main [`README.md`](../README.md).
